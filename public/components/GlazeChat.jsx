...
export default function GlazeChat() {
  ...
  const extractLeadInfo = (conversation) => {
    const data = {}
  ...
  const hasVitalContactInfo = (leadData) => {
  ...
  const GLASS_FAQ = [
    {
      ...
      a: "We offer annealed, tempered, laminated, insulated, Low-E, fire-rated, and safety glass for all residential and commercial needs.",
    },
    {
      q: "How do I get a quote?",
      a: "Just tell me about your project and I’ll provide a rough estimate or connect you with a specialist for a detailed quote.",
    },
    {
      q: "Can you repair broken windows or doors?",
      a: "Yes! We repair and replace all types of glass, including windows, doors, mirrors, and more.",
    },
    {
      q: "How long does installation take?",
      a: "Most projects are completed within 2–3 weeks from measurement to installation.",
    },
    {
      q: "What is Low-E glass?",
      a: "Low-E glass has a special coating to improve energy efficiency by reflecting heat while letting light through.",
    },
    {
      q: "Is my project covered by warranty?",
      a: "Most products include a manufacturer’s warranty; details vary by product.",
    },
    {
      q: "Can I upload a photo for a quote?",
      a: "Yes! Please upload a photo of your project and we’ll provide a more accurate estimate.",
    },
  ]
